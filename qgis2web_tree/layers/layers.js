...
ol.proj.get("EPSG:2326").setExtent([783943.827759, 790136.770464, 890205.400644, 855948.495992]);
var wms_layers = [];
...
var format_ELEVLINE_1 = new ol.format.GeoJSON();
var features_ELEVLINE_1 = format_ELEVLINE_1.readFeatures(json_ELEVLINE_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2326'});
var jsonSource_ELEVLINE_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ELEVLINE_1.addFeatures(features_ELEVLINE_1);
var lyr_ELEVLINE_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_ELEVLINE_1, 
                style: style_ELEVLINE_1,
                interactive: true,
    title: 'ELEVLINE<br />\
    <img src="styles/legend/ELEVLINE_1_0.png" /> 50m - 100m <br />\
    <img src="styles/legend/ELEVLINE_1_1.png" /> 100m - 200m <br />\
    <img src="styles/legend/ELEVLINE_1_2.png" /> 200m - 300m <br />\
    <img src="styles/legend/ELEVLINE_1_3.png" /> 300m - 500m <br />\
    <img src="styles/legend/ELEVLINE_1_4.png" /> 500m - 950m <br />'
        });
...
var lyr_BDRYLINE_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/BDRYLINE_2_1.png" /> Closed Area Boundary<br />\
    <img src="styles/legend/BDRYLINE_2_2.png" /> Firing Range Boundary<br />\
    <img src="styles/legend/BDRYLINE_2_3.png" /> Harbour Limit<br />'
        });
...
lyr_OSMStandard_0.setVisible(true);lyr_ELEVLINE_1.setVisible(true);lyr_BDRYLINE_2.setVisible(true);lyr_CountryParks_3.setVisible(true);lyr_MarineParks_4.setVisible(true);lyr_tree_5.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_ELEVLINE_1,lyr_BDRYLINE_2,lyr_CountryParks_3,lyr_MarineParks_4,lyr_tree_5];
lyr_ELEVLINE_1.set('fieldAliases', {'gml_id': 'gml_id', 'GRAPHICID': 'GRAPHICID', 'GRAPHICDATASET': 'GRAPHICDATASET', 'EASTING': 'EASTING', 'NORTHING': 'NORTHING', 'CLASS': 'CLASS', 'TYPE': 'TYPE', 'SUBCAT': 'SUBCAT', 'PRIORITY': 'PRIORITY', 'PHYSICALSTATUS': 'PHYSICALSTATUS', 'HEIGHT': 'HEIGHT', 'SOURCE': 'SOURCE', 'LASTUPDATEDATE': 'LASTUPDATEDATE', });
...
lyr_ELEVLINE_1.set('fieldImages', {'gml_id': 'Hidden', 'GRAPHICID': 'Hidden', 'GRAPHICDATASET': 'Hidden', 'EASTING': 'Hidden', 'NORTHING': 'Hidden', 'CLASS': 'Hidden', 'TYPE': 'Hidden', 'SUBCAT': 'Hidden', 'PRIORITY': 'Hidden', 'PHYSICALSTATUS': 'Hidden', 'HEIGHT': 'Range', 'SOURCE': 'Hidden', 'LASTUPDATEDATE': 'Hidden', });
...
lyr_ELEVLINE_1.set('fieldLabels', {'HEIGHT': 'inline label', });
